...
def _build_card_prompt(
    ...
    style_descriptions = {
        "dark-tech": (
            "Dark tech style. Deep navy blue background with subtle data stream patterns, "
            "cyan and blue neon accents, futuristic and professional atmosphere. "
            "Title in bright cyan (#00d4ff), key points in boxes with cyan borders, "
            "summary in a dark panel with cyan accent."
        ),
        "pop": (
            "Pop art style. Vibrant yellow background with red accents, "
            "bold comic-style elements, energetic and playful. "
            "Title in bold red, key points in white boxes with thick black borders, "
            "summary in a dark panel with white text."
        ),
        "cyber": (
            "Cyberpunk style. Dark midnight background with neon cyan and magenta glows, "
            "digital grid patterns, holographic elements, futuristic vibe. "
            "Title in bright cyan (#00e6ff) with glow, key points in dark boxes with cyan borders, "
            "summary in a purple-neon panel."
        ),
        "vaporwave": (
            "Vaporwave aesthetic. Purple-pink gradient background with retro grid lines, "
            "neon glow effects, 80s synthwave feel, dreamy atmosphere. "
            "Title in hot pink neon, key points in semi-transparent boxes with pink borders, "
            "summary in a cyan-neon panel."
        ),
        "glassmorphism": (
            "Glassmorphism style. Soft pastel gradient background (blue to purple), "
            "frosted glass effect panels, minimal and clean, light and airy. "
            "Title in dark navy, key points in frosted glass boxes with subtle borders, "
            "summary in a frosted glass panel."
        ),
        "bauhaus": (
            "Bauhaus design style. Cream white background with bold geometric elements "
            "in red, blue, yellow, and black. Clean lines, constructivist composition. "
            "Title in bold black, key points in white boxes with black borders and red accents, "
            "summary in a solid black panel with white text."
        ),
    }
